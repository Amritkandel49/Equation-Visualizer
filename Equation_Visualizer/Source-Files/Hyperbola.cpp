...
void Hyperbola::specialCurve(RenderWindow& window, graph gr) {
	int n = 100;
	int numPoints = 400; // Number of points to approximate the ellipse
	...
	cout << gr.coeff_of_x2 << " " << gr.coeff_of_xy << " " << gr.coeff_of_y2 << " " << gr.coeff_of_x << " " << gr.coeff_of_y << " " << gr.constant << endl;
	...
	std::cout << ((b * b * h * h) - (a * a * k * k) - (a * a * b * b)) << endl;
